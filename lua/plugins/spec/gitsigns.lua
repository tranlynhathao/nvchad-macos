...
return {
  ...
  opts = {
    ...
    on_attach = function(bufnr)
      ...
      map(bufnr, "x", "<leader>ghs", function() gs.stage_hunk(visual_range()) end, { desc = "Git stage selected hunk" })
      map(bufnr, "n", "<leader>ghr", gs.reset_hunk, { desc = "Git reset hunk" })
      map(bufnr, "x", "<leader>ghr", function() gs.reset_hunk(visual_range()) end, { desc = "Git reset selected hunk" })
      ...
      map(bufnr, "n", "<leader>ghD", function() gs.diffthis "~" end, { desc = "Git diff against previous revision" })
      map(bufnr, "n", "<leader>ghb", function() gs.blame_line { full = true } end, { desc = "Git blame line" })
